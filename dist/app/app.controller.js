    ...
    loginAd(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (login) {
                ...
                throw new common_1.NotFoundException('Auth failed, please try again or contact with provider');
            }
        });
    }
    getProfile(req) {
...
__decorate([
    common_1.Post('azure/login'),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "loginAd", null);
__decorate([
